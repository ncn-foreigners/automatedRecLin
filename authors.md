...
Source:
[`DESCRIPTION`](https://github.com/ncn-foreigners/automatedRecLin/blob/v1.1.0/DESCRIPTION)

Struzik A, Beręsewicz M (2026). *automatedRecLin: Record Linkage Based
on an Entropy-Maximizing Classifier*. R package version 1.1.0,
<https://github.com/ncn-foreigners/automatedRecLin>.

    @Manual{,
      title = {automatedRecLin: Record Linkage Based on an Entropy-Maximizing Classifier},
      author = {Adam Struzik and Maciej Beręsewicz},
      year = {2026},

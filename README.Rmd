...
[![CRAN status](https://www.r-pkg.org/badges/version/automatedRecLin)](https://cran.r-project.org/package=automatedRecLin)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/automatedRecLin)](https://cran.r-project.org/package=automatedRecLin)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/automatedRecLin)](https://cran.r-project.org/package=automatedRecLin)
<!-- badges: end -->
...
+ estimated parameters for the variables using the `"binary"`, `"continuous_parametric"` or `"hit_miss"` methods.
...
The `automatedRecLin` R package can be integrated with the [`blocking`](https://cran.r-project.org/package=blocking) package.
For details, see the vignette entitled *MEC with blocking*.
...
Some elements of the package were designed with the support of [StatsClaw](https://statsclaw.ai).
